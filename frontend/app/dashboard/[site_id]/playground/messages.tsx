import { SendHorizontal, Smile, SmileIcon } from 'lucide-react'
  ...
  return (
    <div className={className}>
      <div className="flex-grow h-full flex flex-col">
        <div className="w-full h-15 p-1 bg-purple-600 dark:bg-gray-800 shadow-md rounded-md rounded-bl-none rounded-br-none">
        ...
        <div className="h-15 p-3 rounded-md rounded-tr-none rounded-tl-none bg-gray-100 dark:bg-gray-800">
          <div className="flex items-center">
            <div className="p-2 text-gray-600 dark:text-gray-200 ">

              <SmileIcon className="w-5 h-5 cursor-pointer" />
